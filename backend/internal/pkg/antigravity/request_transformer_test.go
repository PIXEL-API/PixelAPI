...
func TestGeminiToolConfig_IncludeServerSideToolInvocations(t *testing.T) {
	...
	t.Run("mixed function and google search tools enable server-side invocations", func(t *testing.T) {
	...
	t.Run("google search only leaves the flag unset", func(t *testing.T) {
