...
func TestClientIPHelpersIgnoreSpoofedHeadersFromUntrustedPeer(t *testing.T) {
	...
	r.GET("/t", func(c *gin.Context) {
		c.JSON(200, gin.H{
			...
			"trusted":  GetTrustedClientIP(c),
			"security": GetSecurityClientIP(c),
		})
	})
	...
	require.JSONEq(t, `{"client":"9.9.9.9","trusted":"9.9.9.9","security":"9.9.9.9"}`, w.Body.String())
}
