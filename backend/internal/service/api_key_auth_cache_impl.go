...
const apiKeyAuthSnapshotVersion = 15 // v14: Grok video pricing; v15: Codex alpha/search per-call price
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			NewUserRateEnabled:              apiKey.Group.NewUserRateEnabled,
			NewUserRateMultiplier:           apiKey.Group.NewUserRateMultiplier,
			NewUserRateWindowSeconds:        apiKey.Group.NewUserRateWindowSeconds,
			NewUserRateQuotaUSD:             apiKey.Group.NewUserRateQuotaUSD,
...
func groupAuthSnapshotFromService(group *Group) *APIKeyAuthGroupSnapshot {
	...
	return &APIKeyAuthGroupSnapshot{
		...
		NewUserRateEnabled:              group.NewUserRateEnabled,
		NewUserRateMultiplier:           group.NewUserRateMultiplier,
		NewUserRateWindowSeconds:        group.NewUserRateWindowSeconds,
		NewUserRateQuotaUSD:             group.NewUserRateQuotaUSD,
...
func groupFromAuthSnapshot(snapshot *APIKeyAuthGroupSnapshot) *Group {
	...
	return &Group{
		...
		NewUserRateEnabled:              snapshot.NewUserRateEnabled,
		NewUserRateMultiplier:           snapshot.NewUserRateMultiplier,
		NewUserRateWindowSeconds:        snapshot.NewUserRateWindowSeconds,
		NewUserRateQuotaUSD:             snapshot.NewUserRateQuotaUSD,
