...
// xAI does not accept call_id on replayed non-pair input items. These items
// are retained as context, but their call relationship is represented only
// by function_call/function_call_output pairs.
