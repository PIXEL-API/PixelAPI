...
// ReadOpenAIWSClientMessage keeps a single read goroutine alive while a
// control event sends its close frame, then closes the transport and joins the
// reader. This prevents canceled ingress reads from lingering after teardown.
