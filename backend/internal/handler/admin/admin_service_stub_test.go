...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search, ownerSearch string, groupID, proxyID int64, privacyMode string, sortBy, sortOrder string) ([]service.Account, int64, error) {
	s.lastListAccounts.platform = platform
	s.lastListAccounts.accountType = accountType
	s.lastListAccounts.status = status
	s.lastListAccounts.search = search
	s.lastListAccounts.ownerSearch = ownerSearch
...
func (s *stubAdminService) DuplicateAccount(context.Context, int64, string, string) (*service.Account, error) {
	account := service.Account{ID: 301, Name: "account (Copy)", Status: service.StatusActive, Schedulable: false}
	return &account, nil
}

func (s *stubAdminService) RecoverDuplicateAccount(context.Context, int64, string, string) (*service.Account, error) {
	return nil, nil
}
...
func (s *stubAdminService) ListRedeemCodes(ctx context.Context, page, pageSize int, codeType, status, category, search string, sortBy, sortOrder string) ([]service.RedeemCode, int64, error) {
...
func (s *stubAdminService) ListRedeemCodeCategories(ctx context.Context) ([]string, error) {
	return []string{"campaign", "gift"}, nil
}
