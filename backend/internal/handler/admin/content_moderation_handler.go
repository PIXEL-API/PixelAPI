...
type contentModerationConfigRequest struct {
	...
	CyberPreflightRules   *service.ContentModerationCyberPreflightRulesConfig   `json:"cyber_preflight_rules"`
	...
	DynamicSampling       *service.ContentModerationDynamicSamplingConfig       `json:"dynamic_sampling"`
...
func (h *ContentModerationHandler) UpdateConfig(c *gin.Context) {
	...
	cfg, err := h.service.UpdateConfig(c.Request.Context(), service.UpdateContentModerationConfigInput{
		Enabled:               req.Enabled,
		CyberPreflightEnabled: req.CyberPreflightEnabled,
		CyberPreflightRules:   req.CyberPreflightRules,
		Mode:                  req.Mode,
		...
		DynamicSampling:       req.DynamicSampling,
