-- Add a V3 billing command contract for settlement_enabled while preserving
-- the exact historical V1/V2 key sets. Sensitive or unknown keys still fail.
...
COMMENT ON CONSTRAINT account_share_billing_intent_payload_chk
    ...
    IS 'Versioned V1/V2/V3 allowlists reject unknown and sensitive billing payload keys; settlement_enabled starts in V3.';
