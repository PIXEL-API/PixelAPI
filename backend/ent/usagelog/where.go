...
// RateMultiplierSource applies equality check predicate on the "rate_multiplier_source" field. It's identical to RateMultiplierSourceEQ.
func RateMultiplierSource(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldRateMultiplierSource, v))
}
...
// RateMultiplierSourceEQ applies the EQ predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceEQ(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceNEQ applies the NEQ predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceNEQ(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNEQ(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceIn applies the In predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceIn(vs ...string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldIn(FieldRateMultiplierSource, vs...))
}

// RateMultiplierSourceNotIn applies the NotIn predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceNotIn(vs ...string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNotIn(FieldRateMultiplierSource, vs...))
}

// RateMultiplierSourceGT applies the GT predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceGT(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGT(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceGTE applies the GTE predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceGTE(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGTE(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceLT applies the LT predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceLT(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLT(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceLTE applies the LTE predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceLTE(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLTE(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceContains applies the Contains predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceContains(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldContains(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceHasPrefix applies the HasPrefix predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceHasPrefix(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldHasPrefix(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceHasSuffix applies the HasSuffix predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceHasSuffix(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldHasSuffix(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceEqualFold applies the EqualFold predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceEqualFold(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEqualFold(FieldRateMultiplierSource, v))
}

// RateMultiplierSourceContainsFold applies the ContainsFold predicate on the "rate_multiplier_source" field.
func RateMultiplierSourceContainsFold(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldContainsFold(FieldRateMultiplierSource, v))
}
