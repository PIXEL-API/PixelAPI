...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "new_user_rate_enabled", Type: field.TypeBool, Default: false},
		{Name: "new_user_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "new_user_rate_window_seconds", Type: field.TypeInt, Default: 0},
		{Name: "new_user_rate_quota_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "refund_trade_no", Type: field.TypeString, Size: 128, Default: ""},
		{Name: "refund_deduct_on_settle", Type: field.TypeBool, Default: false},
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "category", Type: field.TypeString, Size: 64, Default: ""},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "rate_multiplier_source", Type: field.TypeString, Size: 50, Default: ""},
