...
type UsageLog struct {
	...
	// 费率倍率来源快照，如 group_default/new_user_group/user_group/account_share
	RateMultiplierSource string `json:"rate_multiplier_source,omitempty"`
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldUpstreamResponseModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldRateMultiplierSource, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldRateMultiplierSource:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field rate_multiplier_source", values[i])
			} else if value.Valid {
				_m.RateMultiplierSource = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("rate_multiplier_source=")
	builder.WriteString(_m.RateMultiplierSource)
	builder.WriteString(", ")
