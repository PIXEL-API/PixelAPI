export default {
  ...
  userAccounts: {
    ...
    externalPlacement: {
      action: "Change external placement",
      private: "Owner only",
      publicPool: "Public pool",
      room: "Account room",
      roomNamed: "Room: {name}",
      privateHint: "This account is available only to its owner and is not placed in a public pool or room.",
      publicPoolHint: "This account is in the public pool and remains available to its owner.",
      roomHint: "This account is in one of the owner's rooms and remains available to its owner.",
      converted: "External placement changed",
      unchanged: "The account is already in the selected placement",
      title: "Change external placement",
      destination: "Choose a destination",
      publicPoolShort: "Public pool",
      roomShort: "Account room",
      privateShort: "Owner only",
      privateTitle: "Leave external sharing",
      privateDescription: "Remove the account from its public pool or room while keeping owner access.",
      ...
      roomTitle: "Account room",
      roomDescription: "Join a room with the same owner, platform, and account level.",
      roomLabel: "Choose an account room",
      roomRule: "Only rooms with the same owner, platform, and account level are shown.",
      noCompatibleRooms: "No compatible rooms are available.",
      roomCapacity: "Healthy accounts {healthy}/{total}",
      credentialsPreserved: "Conversion keeps the account, credentials, proxy, and private owner access unchanged.",
      converting: "Changing...",
      confirm: "Confirm change",
      uuidUnavailable: "This browser cannot generate a secure idempotency key. Upgrade it and try again.",
      unsupportedPlatform: "Account rooms are not supported for this platform.",
      unknownLevel: "Confirm the account level before joining a room.",
      ownerRequired: "The account owner cannot be confirmed, so compatible rooms cannot be loaded.",
      roomLoadFailed: "Failed to load compatible rooms. Try again.",
      convertFailed: "Failed to change the external placement. Try again."
    },
    ...
    levelPlusRejected:
      "Plus verification did not pass. The account was kept or changed back to Free.",
    levelPlusRejectedWithReason: "Plus verification did not pass: {reason}",
    levelVerifyFailed: "Failed to verify account level",
    levelVerifyInProgress:
      "An account level verification is already running. Please try again later.",
    noGroups: "No groups",
