export default {
  ...
  userAccounts: {
    ...
    externalPlacement: {
      ...
      room: "账号房间",
      roomNamed: "房间：{name}",
      privateHint: "账号仅供号主本人调用，没有加入公共号池或账号房间。",
      publicPoolHint: "账号已加入公共号池，同时仍可供号主本人调用。",
      roomHint: "账号已加入号主自己的账号房间，同时仍可供号主本人调用。",
      converted: "外投位置已转换",
      unchanged: "账号已经位于目标位置",
      title: "切换外投位置",
      destination: "选择目标位置",
      publicPoolShort: "公共号池",
      roomShort: "账号房间",
      privateShort: "仅本人",
      privateTitle: "退出外投（仅本人）",
      privateDescription: "移出公共号池或账号房间，仅保留号主自己的私有调用。",
      publicPoolTitle: "公共号池",
      publicPoolDescription: "账号可被公共调度，同时号主仍可按全局自用抽成调用。",
      roomTitle: "账号房间",
      roomDescription: "加入同号主、同平台、同账号等级的房间。",
      roomLabel: "选择账号房间",
      roomRule: "仅显示同号主、同平台、同等级的房间。",
      noCompatibleRooms: "暂无可加入的同平台同等级房间。",
      roomCapacity: "健康账号 {healthy}/{total}",
      credentialsPreserved: "转换不会删除账号或重新登录，账号凭证、代理和私有自用能力保持不变。",
      converting: "转换中...",
      confirm: "确认转换",
      uuidUnavailable: "当前浏览器无法生成安全的幂等键，请升级浏览器后重试。",
      unsupportedPlatform: "当前账号平台暂不支持账号房间。",
      unknownLevel: "账号等级未知，确认等级后才能加入房间。",
      ownerRequired: "无法确认账号号主，不能加载可加入房间。",
      roomLoadFailed: "加载可加入房间失败，请重试。",
      convertFailed: "外投位置转换失败，请重试。"
    },
    pendingReview: "待校验",
    approved: "已通过",
    suspended: "已暂停",
  ...
  keys: {
    ...
    imagePlaygroundModelDialog: {
      title: "选择图片模型",
      description: "已默认填写图片模型，可按需修改本次调用要使用的模型。",
      modelLabel: "图片模型",
