export default {
  ...
  activities: {
    ...
    editorial: {
      ...
      headline: "让每一次使用，都有回响",
      lead:
        "消费达标、主动入池、等待开奖。正在发生的福利、领奖进度与邀请收益，都收进这一份清晰的会员活动索引。",
      currentIssue: "本期进行",
      activityUnit: "{count} 项活动",
      overview: "会员福利概览",
      index: "活动索引",
      indexHint: "选择你要查看的内容",
      progress: "达标进度",
      ...
      publicBoardHint: "公开中奖信息",
      entry: "ENTRY",
      archive: "ARCHIVE",
      recorded: "已收录",
      claimLabel: "PRIZE CLAIM / 领奖登记",
      shareLabel: "INVITE & EARN",
      shareHeadline: "把好用的服务，分享给值得的人",
      inviteeLedger: "INVITEE LEDGER / 邀请明细",
      periodFilter: "收益统计周期",
      ...
      sections: {
        open: {
          ...
          title: "正在发生",
          description: "达标后将机会投入开奖池，进度、奖品与公示都保持清晰透明。",
        },
        joined: {
          eyebrow: "MY ENTRIES / 02",
          title: "参与档案",
          description: "每一次已投入的抽奖机会都在这里留有记录，也可以补充新获得的机会。",
        },
        winners: {
          eyebrow: "WINNING NOTES / 03",
          title: "我的领奖票据",
          description: "中奖不是终点。及时补充领奖资料，并持续跟进奖品状态。",
        },
        past: {
          eyebrow: "THE ARCHIVE / 04",
          title: "往期归档",
          description: "回看已经落幕的活动、参与次数与最近中奖公示。",
        },
        affiliate: {
          eyebrow: "SHARE & EARN / 05",
          title: "邀请收益",
          description: "一处完成分享、收益查看、统计周期筛选和邀请用户追踪。",
        },
      },
    },
    loadFailed: "加载福利活动失败",
