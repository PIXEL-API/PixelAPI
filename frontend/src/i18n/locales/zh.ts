export default {
  ...
  userAccounts: {
    ...
    levelPlusVerified: "Plus 校验已通过，账号等级已更新",
    levelPlusRejected: "Plus 校验未通过，账号已保持或切回 Free",
    levelPlusRejectedWithReason: "Plus 校验未通过：{reason}",
    levelVerifyFailed: "账号等级校验失败",
    levelVerifyInProgress: "已有账号等级校验正在进行，请稍后再试",
    noGroups: "无分组",
  ...
  affiliate: {
    title: "邀请收益",
    description:
      "邀请新用户注册，被邀请用户使用共享号池消费时，你可按比例获得实时余额收益",
    yourCode: "我的邀请码",
    inviteLink: "邀请链接",
    copyCode: "复制邀请码",
    copyLink: "复制链接",
    ...
    tips: {
      ...
      line2:
        "被邀请用户在有效期内使用共享号池消费时，你可获得 {rate} 的邀请收益。",
  ...
  admin: {
    ...
    revenue: {
      ...
      sharePolicy: {
        title: "统一分成策略",
        description:
          "配置全站公开个人账号的账号主分成和邀请分成比例。平台比例自动吃剩余，策略只影响后续 usage 结算。",
        currentPolicy: "当前生效策略",
        currentPolicyHint:
          "公开账号进入共享号池前会校验这里的生效策略。用户本人调用自己的账号不会产生分成收入，也不会进入利润分成统计。",
        globalConfig: "全局策略配置",
        privateGroupCommissionTitle: "私有分组抽成",
        privateGroupCommissionDescription:
          "配置私有分组请求的额外平台抽成比例。请求仍按订阅窗口扣费，同时会从用户钱包余额额外扣除这部分抽成。",
        ...
        modePolicyDescription:
          "配置账号共享模式的独立分成比例。该策略只用于账号广场绑定后的账号模式请求，不影响共享号池抽成。",
        modeCurrentPolicy: "当前账号模式策略",
        modeGlobalConfig: "账号模式全局配置",
        modePolicyHint:
          "默认平台留存 10%，账号主获得 90%。每次 usage 会写入当时的倍率、耗时费和分成快照。",
        ...
        ownerShareHint:
          "别人调用公开账号时，按使用者扣费金额计算给账号主的比例。",
        inviteShareHint:
          "被邀请用户在有效期内调用共享号池时，按使用者扣费金额计算给邀请人的比例。",
        platformShareHint: "系统自动按 100% 减去账号主分成和邀请分成比例计算。",
        saveHint:
          "保存后立即作为新的全局生效策略。历史 usage 已按当时快照结算，不会被新比例改写。",
        savePolicy: "保存策略",
        effectiveAt: "生效时间",
        updatedAt: "更新时间",
        version: "版本",
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: "邀请收益",
          description:
            "老用户邀请新用户注册，新用户在有效期内使用共享号池消费时，邀请人按分成策略获得实时余额收益。",
          enabled: "启用邀请收益",
          enabledHint:
      ...
      payment: {
        ...
        tabVisibilityTitle: "充值/订阅页显示",
        tabVisibilityHint:
          "关闭后，用户侧充值/订阅页将不显示对应的顶部 Tab 和内容区域。",
        ...
        announcementPlaceholder: "输入进入充值/订阅页时展示给用户的公告...",
        announcementHint: "公告会显示在用户充值/订阅页顶部，留空则不显示。",
        rechargeCenterTitle: "充值中心",
        rechargeCenterHint:
          "配置用户充值/订阅页中的外部入口，用户点击后默认新窗口打开。",
        rechargeCenterEmpty: "暂未配置充值中心入口",
