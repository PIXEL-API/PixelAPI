<template>
  <div class="flex min-w-0 flex-1 items-start justify-between gap-3">
    ...
    >
      <!-- Row 1: optional API key badge + platform badge -->
      <div class="flex min-w-0 flex-wrap items-center gap-1.5">
        <GroupApiKeyBadge
          :type="apiKeyBadgeType"
          :text="apiKeyBadgeText"
          :scope="scope"
        />
        <GroupBadge
          :name="name"
...
import GroupApiKeyBadge from './GroupApiKeyBadge.vue'
import type {
...
interface Props {
  ...
  apiKeyBadgeType?: ApiKeyGroupBadgeType | null
  apiKeyBadgeText?: string | null
  selected?: boolean
